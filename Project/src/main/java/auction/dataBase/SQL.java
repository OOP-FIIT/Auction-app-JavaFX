...
public class SQL {
   ...
   public static int InsertUser(String login, String password, String email, String mode, int balance)
         throws SQLException {
      Statement stmt = conn.createStatement();
   ...
   public static void UPDATE_User(String password, String login, String email, String mode, Integer balance,
         boolean balanceAdd, int id) throws SQLException {
      Statement stmt = conn.createStatement();
      String sql = "UPDATE " + Const.SQL.USERDATA + " " +
            "\nSET"
            ...
            + (balance != null
                  ? " " + Const.SQL.USERDATA_BALANCE + "=" + (balanceAdd ? Const.SQL.USERDATA_BALANCE + "+" : "")
                        + balance + " "
                  : "")
